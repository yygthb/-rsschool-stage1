...
2. "Garage" view:
  ...
  - (10/10) There should be a button to create random cars (10 cars per click). Name should be assembled from two random parts. Color should be also generated randomly.
3. Car animation:
